...
class ForcepointEngineRouting(ForcepointModuleBase):
    def __init__(self):
        ...
        super(ForcepointEngineRouting, self).__init__(self.module_args, supports_check_mode=True)
