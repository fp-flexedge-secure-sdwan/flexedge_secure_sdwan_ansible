...
---
module: l3fw_cluster
short_description: Create or delete Forcepoint NGFW clusters
description:
          ...
          external_bgp_peer:
            description:
              - If the external BGP peer next hop is an external bgp peer SMC element,
                use this identifier. Otherwise use engine if its another managed firewall.
            type: str
          engine:
            description:
...
try:
    ...
    # Caught in ForcepointModuleBase
    pass
...
class ForcepointCluster(ForcepointModuleBase):
    def __init__(self):
        ...
        super(ForcepointCluster, self).__init__(self.module_args, supports_check_mode=True)
