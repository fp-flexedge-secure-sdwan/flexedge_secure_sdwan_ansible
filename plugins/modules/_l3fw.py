...
---
module: l3fw
short_description: Create or delete a firewall
description:
  - Create or delete a Firewall on the Forcepoint NGFW
    Management Center.
...
options:
  ...
  enable_ospf:
    description:
      - Enable OSPF on the firewall management interface
    type: bool
    default: false
...
class ForcepointFirewall(ForcepointModuleBase):
    def __init__(self):
        ...
        super(ForcepointFirewall, self).__init__(self.module_args, supports_check_mode=True)
